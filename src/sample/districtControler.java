...
public class districtControler implements Initializable {

    ObservableList districtBox = FXCollections.observableArrayList();
    @FXML
    ...
    @FXML
    private ChoiceBox<String> districtList;

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File logofile = new File("@../../Images/vote45a.jpg");
        Image logoImage = new Image(logofile.toURI().toString());
        hImageView.setImage(logoImage);

        selectBox1();
    }

    public void bbuttonOnAction(ActionEvent event) throws IOException {
        Parent page2Parent2 = FXMLLoader.load(getClass().getResource("Thanks.fxml"));

        Stage window = (Stage) bButton.getScene().getWindow();
    ...
    public void rbuttonOnAction(ActionEvent event) {
        ...
        textArea.setText(tema.districtResults());
    }

    public void regionalbuttonOnAction(ActionEvent event) throws IOException {
        Parent page2Parent = FXMLLoader.load(getClass().getResource("regional.fxml"));

        Stage window = (Stage) rButton.getScene().getWindow();
    ...
    private void selectBox1(){
        districtBox.removeAll(districtBox);
        String a = "Takoradgi";
        String b = "Tema";
        String c = "santa";
        districtBox.addAll(a,b,c);
        districtList.getItems().addAll(districtBox);
